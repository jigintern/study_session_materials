...
プログラム通り、右側の Console に「hello 1」から「hello 5」と表示されることを確認しよう。

## 3-2. DartPad で Flutter アプリを動かしてみよう
