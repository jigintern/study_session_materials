...
**📝課題**: あなたの好きなうどんのメニュー名ひとつと、実験の感想を200字程度で記述しなさい。（2点）
...
以下の[コード 5.4.3-1.](#c543-1)に示すHTMLを、コメントを置き換えつつ追記してみてください。
...
<figcaption><a id="c6311">コード 6.3.1.1. カスタムプロパティの宣言</a></figcaption>
...
<figcaption><a id="c6312">コード 6.3.1.2. カスタムプロパティの使用</a></figcaption>
...
<figcaption><a id="f6311">図 6.4.1.1. 一般的なウェブページの例</a></figcaption>
...
<figcaption><a id="f6312">図 6.4.1.2. 聖杯レイアウトの部分の名称</a></figcaption>
...
<figcaption><a id="c6411">コード 6.4.1.1. 聖杯レイアウトの元になるHTML</a></figcaption>
...
<figcaption><a id="c6422">コード 6.4.2.1. フレックスボックスを利用して聖杯レイアウトを実現するCSS</a></figcaption>
...
<figcaption><a id="c6421">コード 6.4.3.1. グリッドレイアウトを利用して聖杯レイアウトを実装する準備</a></figcaption>
...
<figcaption><a id="c6432">コード 6.4.3.2. グリッドレイアウトを利用して聖杯レイアウトを実現するCSS</a></figcaption>
