...
![図 2.2.1. ネイティブアプリケーションのコンテンツ配信](imgs/smartphone-application-delivery.drawio.png)

<figcaption><a id="f221">図 2.2.1. ネイティブアプリケーションのコンテンツ配信</a></figcaption>
...
![図 2.2.2. ウェブアプリケーションのコンテンツ配信](imgs/web-application-delivery.drawio.png)

<figcaption><a id="f222">図 2.2.2. ウェブアプリケーションのコンテンツ配信</a></figcaption>
