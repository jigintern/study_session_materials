...
<figcaption><a id="c632-1">コード 6.3.1-1. カスタムプロパティの宣言</a></figcaption>
...
<figcaption><a id="c632-2">コード 6.3.1-2. カスタムプロパティの使用</a></figcaption>
...
**📝課題**: 自分の好きな色を文字色に適用して、ブラウザでの表示をスクリーンショットで撮影し、それをレポートに添付しなさい。（1点）
...
VSCodeのエクスプローラーから`holy-grail.html`と`holy-grail.css`の2つのファイルを作成し、`holy-grail.html`には[コード 6.4.1.-.](#c641-1)の内容を貼り付けてください。
...
**📝課題**: グリッドレイアウトにより習熟するための教材として[Grid Garden](https://cssgridgarden.com/#ja)があります。これに取り組み、全28問題をすべてクリアして、ドロップダウンメニューのレベルがすべて緑に点灯している状態のスクリーンショットを取り、レポートに添付しなさい。（3点）
...
<figcaption><a id="c733-2"></a></figcaption>
